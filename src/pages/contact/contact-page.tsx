  ...
  return (
    <main className="container page-container">
      ...
      >
        ...
        your message.
        {"\n  "} <br />
        Have a question or want to request a quote? Fill the form or use the
        details on the right to reach our team.
      </PageIntro>
        ...
        <aside aria-labelledby="company-details-heading" className="p-8">
          ...
          <div className="dashboard-card plan-card my-4">
            ...
            <div className="activity-list">
              ...
              <a href="https://x.com" target="_blank" className="activity-row">
                <div className="activity-icon">
